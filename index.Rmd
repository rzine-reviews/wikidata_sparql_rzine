...
Formalisation de la recherche d'une liste ordonnée des oeuvres de Vermeer, en langue anglaise, mobilisant le préfixe Wikidata `wdt` associé aux valeurs simples :
...
Formalisation de la recherche d'une liste ordonnée des oeuvres de Vermeer, en langue anglaise, mobilisant les préfixes Wikidata `p/ps` associé aux déclarations (valeurs complexes) :
...
Formalisation de la recherche d'une liste ordonnée du nombre de musées où se trouvent un oeuvre de Vermeer, en langue anglaise, mobilisant le préfixe Wikidata `wdt` associé aux valeurs simples pour les musées :
...
Formalisation de la recherche d'une liste ordonnée du nombre de musées où se trouvent un oeuvre de Vermeer, en langue anglaise, mobilisant les préfixes Wikidata `p/ps` associés aux valeurs complexes ou déclarations pour les musées :
...
Formalisation de la recherche d'une liste des musées et d'intervalles de temps associés où se trouvent l'oeuvre choisie de Vermeer, en langue anglaise, mobilisant le préfixe de propriété directe Wikidata `p` associé à la localisation `P276` de l'oeuvre dans le temps :
...
Formalisation de la recherche d'une illustration de l'oeuvre choisie de Vermeer :
