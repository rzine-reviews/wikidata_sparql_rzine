...
- `glitter` : permet l'écriture et l'envoi de requêtes SPARQL;    
...
Pour installer le package `glitter` [mis à disposition sur GitHub](https://github.com/lvaudor/glitter/) :

```{r install2, eval=FALSE, echo=TRUE, include=TRUE, message=FALSE, warning=FALSE}
