...
Le fragment de graphe de données Wikidata utilisé ici est illustré en figure 6b, ci-dessous.
</br>
...
```
<center>
Figure 5 : **Illustration de wikidata pouridentifier visuellement le peintre Johannes Vermeer**
</center>
</br>    
...
On constate dans le tableau de résultat ci-dessus que les données (non supervisées) concernant le lieu d'exposition sont très hétérogènes. Alors que certaines œuvres n'ont aucun lieu d'exposition indiqué car l'information n'est tout simplement pas disponible, d'autres présentent plusieurs localisations et dans certains cas, plusieurs fois le même musée. 
