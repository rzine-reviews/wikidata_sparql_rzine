...
Seul R est indispensable pour reproduire ce document. Mais il est fortement conseillé d'installer également l'IDE Rstudio qui facilite considérablement la pratique de R et la production de documents au format [Rmarkdown](https://rmarkdown.rstudio.com/){target="_blank"}.  
...
- **la localisation de l'entité au moyen de la propriété ([P276]((https://www.wikidata.org/wiki/Property:P276){target="_blank"}))**, permettant l'accès aux assertions ou déclarations de localisation de l'œuvre dans un lieu (géographique & institutionnel) : `wdt:P276` ou d'un espace de temps (couplant lieu et laps de temps) : `p:P276`associée aux [*qualifiers*]((https://www.wikidata.org/wiki/Help:Qualifiers){target="_blank"}) de la déclaration (préfixes `pq:P580` ou `pq:P82`) ;
