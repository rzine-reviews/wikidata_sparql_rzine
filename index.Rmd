...
**Ce document computationnel (Notebook) peut être reproduit à l'identique sur un ordinateur**. **Pour cela il est nécessaire d'avoir installé R**.   
Il est nécessaire également d'installer deux *packages*[^1] (`knitr` et `rmdformats`).
...
## `knitr` & `rmdformats`
Deux *packages*[^1] sont nécessaires pour reproduire ce document à l'identique :  
